...
\begin{frame}{\href
    ...
    \[ \wph \quad\&\quad \wi\wph\wps \quad\implies\quad \wps \tag{\mmlink{ax-mp}} \]
\end{frame}
...
\begin{frame}[label=ax-2]{公理 2：蘊涵的分配律}
...
\begin{frame}[label=a1i]{公理 1 的推論形式}
    \begin{theorem}[\mmurl{a1i}]
        ...
        \begin{mmproof}{2em}{3em}
            ...
            \statement{\mmlink{ax-1}}
                $\axI\wph\wps$
                \label{a1i:2}
            \statement[\ref{a1i:1}, \ref{a1i:2}]{\mmlink{ax-mp}}
                $\wi\wps\wph$
        \end{mmproof}
    \end{theorem}
\end{frame}

\begin{frame}[label=a2i]{公理 2 的推論形式}
    \begin{theorem}[\mmurl{a2i}]
        ...
        \begin{mmproof}{2em}{3em}
            ...
            \statement{\mmlink{ax-2}}
                ...
                \label{a2i:2}
            \statement[\ref{a2i:1}, \ref{a2i:2}]{\mmlink{ax-mp}}
                $\aIIi\wph\wps\wch$
        \end{mmproof}
    \end{theorem}
\end{frame}

\begin{frame}[label=mpd]{肯定前件的演繹}
...
\begin{frame}{肯定前件的演繹的證明}
    \begin{mmproof}{2em}{3em}
        ...
        \statement[\ref{mpd:2}]{\mmlink{a2i}}
            $\aIIi\wph\wps\wch$
            \label{mpd:3}
        \statement[\ref{mpd:1}, \ref{mpd:3}]{\mmlink{ax-mp}}
            $\wi\wph\wch$
    \end{mmproof}
\end{frame}
...
\begin{frame}{三段論的證明}
    \begin{mmproof}{2em}{3em}
        ...
        \statement[\ref{syl:2}]{\mmlink{a1i}}
            $\wi\wph{\wi\wps\wch}$
            \label{syl:3}
        \statement[\ref{syl:1}, \ref{syl:3}]{\mmlink{mpd}}
            $\wi\wph\wch$
    \end{mmproof}
\end{frame}
    ...
    \begin{theorem}[\mmurl{id}]
        ...
        \begin{mmproof}{2em}{3em}
            ...
            \statement{\mmlink{ax-1}}
                $\axI\wph{\wi\wph\wph}$
                \label{id:2}
            \statement[\ref{id:1}, \ref{id:2}]{\mmlink{mpd}}
                $\wi\wph\wph$
        \end{mmproof}
    \end{theorem}
\end{frame}
    ...
    \begin{theorem}[\mmurl{a1d}]
        ...
        \begin{mmproof}{2em}{4em}
            ...
            \statement{\mmlink{ax-1}}
                $\axI\wps\wch$
                \label{a1d:2}
            \statement[\ref{a1d:1}, \ref{a1d:2}]{\mmlink{syl}}
                $\wi\wph{\wi\wch\wps}$
        \end{mmproof}
    \end{theorem}
\end{frame}
    ...
    \begin{theorem}[\mmurl{con4d}]
        ...
        \begin{mmproof}{2em}{4em}
            ...
            \statement{\mmlink{ax-3}}
                $\axIII\wps\wch$
                \label{con4d:2}
            \statement[\ref{con4d:1}, \ref{con4d:2}]{\mmlink{syl}}
                $\wi\wph{\wi\wch\wps}$
        \end{mmproof}
    \end{theorem}
\end{frame}
